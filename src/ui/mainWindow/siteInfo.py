...
class SiteInfo(QtWidgets.QFrame):
    # elev, press
    def __init__(self, sitename, imagername, lat, long, parent=None):
        super(SiteInfo, self).__init__(parent)

        # Init Widgets
        self.init_site_widgets(sitename, imagername)
        self.init_geo_widgets(lat, long)
        self.config_widget()
    ...
    # elev, press
    def init_geo_widgets(self, lat, long):
    ...
    # ele, pre
    def set_geo_values(self, lat, lon):
